...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      content:
        'Bee in control of your finances with BeeRich - the buzzworthy expense and income tracker with a morden interface. Keep your finances organized and make honey with your money!',
    },
  ];
};
